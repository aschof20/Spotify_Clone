...
if (isset($_GET['term'])) {
    // Replace whitespace encoded (%20) in search term
...
<div class="searchContainer">
    ...
    <input type="text" class="searchInput" value="<?php
    echo $term; ?>" placeholder="Start typing..." onfocus="this.value = this.value">
